    ...
    if(isset($_GET['id'])){
        ...
        $image =$_POST["image"];
        $id=$_POST['id'];
        $sql="UPDATE employe1 set matricule='$matricule',nom='$nom',prénom='$prénom',date='$date',département='$département',salaire='$salaire',fonction='$fonction',image='$image' where id='$id'";
